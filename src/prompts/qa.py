...
7. explanation — compress the source explanation to ~100 words (hard ceiling 130, soft floor 80). Keep critical reasoning; drop restatements. Use LaTeX. End with one sentence stating the answer (e.g. "The answer is $\\frac{{1}}{{2}}$.").
